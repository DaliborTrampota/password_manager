...
class Storage {
  ...
  static Future<void> createSite(AccountEntry data) async {
  ...
  static Future<void> editSite(String name, AccountEntry newData) async {
    await Storage.removeSite(name);
    await Storage.createSite(newData);
    return;
  }
}
